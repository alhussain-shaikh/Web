      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            Connection con =DriverManager.getConnection(url, "root", "040703"); 
            ...
            <td>
              ...
              ResultSet rs2 = stmt2.executeQuery("select * from categories where categoryid = "
              + categoryid + ";"); if(rs2.next()) { out.print(rs2.getString(2));
              } %>
            </td>
